...
return(
     <div class="p-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 mt-[70px] lg:ml-[40px]">
    <div class=" p-4">
      <img class="w-full h-[250px] md:h-[300px] object-cover"
      ...
      <h1 class="font-sans text-[15px] font-bold pt-4 pb-3">Brand Assets</h1>
      <p class="font-sans text-[10px] text-start">
    ...
    <div class=" p-4">
      ...
      <h1 class="font-sans text-[15px] font-bold pt-4 pb-3">About US</h1>
      <p class="font-sans text-[10px] text-start">
    ...
    <div class=" p-4">
      ...
      <h1 class="font-sans text-[15px] font-bold pt-4 pb-3">Investor Relations</h1>
      <p class="font-sans text-[10px] text-start">
